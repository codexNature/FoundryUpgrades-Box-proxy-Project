...
//         address mostRecentlyDeployedProxy = DevOpsTools.get_most_recent_deployment("ERC1976Proxy", block.chainid);
...
//         proxy.upgradeToAndCall(address(newBox), new bytes(0)); //proxy contract now points to new address
//         vm.stopBroadcast();
